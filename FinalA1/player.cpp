...
date: 3/13/2016
desc: child of actor -- player stores the player point
input: n/a
...
/*func: move
desc: handles all character movement and input handling
para: column and row as ints and the map as a char**
input: single user char
output: updated player action
*/
